...
# コピー対象のファイルとディレクトリ
RULE_FILES := .roomodes
RULE_DIRS := .roo/rules .roo/rules-task-design .roo/rules-task-execution .roo/rules-test-implementation .roo/rules-implementation .roo/rules-debug .roo/rules-create-docs .roo/rules-environment-setup .roo/rules-initial-design .roo/rules-create-git-repository
